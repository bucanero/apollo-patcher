 ...
 *
 * VENDORED from bucanero/ps2vmc-tool (web-ps2/hexedit.js), unmodified so it can
 * be refreshed from there. It ships its own dark stylesheet; this app themes it
 * from style.css instead of forking the file (see the .hx-* rules there).
 */
